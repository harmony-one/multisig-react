...
export const SQUARELINK_ID = {
  [HARMONY_NETWORK.RINKEBY]: '46ce08fe50913cfa1b78',
  [HARMONY_NETWORK.MAINNET]: process.env.REACT_APP_SQUARELINK_ID,
  [HARMONY_NETWORK.XDAI]: process.env.REACT_APP_SQUARELINK_ID,
}
 */
